...
contract BlockSafe is IBlockSafe, ERC165, ERC721Holder, ERC1155Holder, ReentrancyGuard {
    ...
    function supportsInterface(bytes4 interfaceId)
        ...
        returns (bool)
    {
        return interfaceId == type(IBlockSafe).interfaceId || super.supportsInterface(interfaceId);
    }
