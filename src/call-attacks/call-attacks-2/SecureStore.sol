...
contract SecureStore {
    // @audit-issue fn rentWarehouse(_renterId) user controlled
    // RentingLibrary updates slot0 of storage with _renterId (delegatecall)
    // SecureStore slot0 is contract calling address (our contract must have the same function name and same parameter types)
