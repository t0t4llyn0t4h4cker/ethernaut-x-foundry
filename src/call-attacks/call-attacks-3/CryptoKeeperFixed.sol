...
contract CryptoKeeperFixed is ICryptoKeeper, ERC165, ERC721Holder, ERC1155Holder, ReentrancyGuard {
    ...
    // @audit add isLocked modifier
    function initialize(address[] calldata _operators) external isLocked {
        initialized = true;
        locked = true;
