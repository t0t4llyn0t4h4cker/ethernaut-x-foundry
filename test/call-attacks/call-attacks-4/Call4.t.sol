...
contract Call4Test is Test {
    ...
    function testUser1CreateKeeper() public {
        ...
        IBlockSafe(blockSafe1Address).addOperator(userAddress2);
        vm.expectRevert("Not an operator");
        IBlockSafe(blockSafe1Address).executeWithValue{value: VALUE}(userAddress2, "0x", VALUE);
        vm.stopPrank();
    }
    ...
    function testUser2CreateKeeper() public {
        ...
        address cryptKeeper2AddressCreated = blockSafeFactory.createBlockSafe(user2Salt, operators);
    ...
    function testUser3CreateKeeper() public {
        ...
        address cryptKeeper3AddressCreated = blockSafeFactory.createBlockSafe(user3Salt, operators);
    ...
    function testStealEther() public {
        ...
        IBlockSafe(address(blockSafeTemplate)).initialize(operators);
